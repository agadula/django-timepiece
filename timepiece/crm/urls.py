...
urlpatterns = patterns('',
    ...
    url(r'^user/(?P<user_id>\d+)/timesheet/api/$',
        views.TimesheetEntryAPI.as_view(),
        name='timesheet_entries_api'),
    url(r'^user/(?P<user_id>\d+)/timesheet/api/verify/$',
        views.TimesheetEntryStatusAPI.as_view(),
        {'action': 'verify'},
        name='verify_timesheet_entries'),
    url(r'^user/(?P<user_id>\d+)/timesheet/api/approve/$',
        views.TimesheetEntryStatusAPI.as_view(),
        {'action': 'approve'},
        name='approve_timesheet_entries'),
    url(r'^user/(?P<user_id>\d+)/timesheet/api/reject/$',
        views.TimesheetEntryStatusAPI.as_view(),
        {'action': 'reject'},
        name='reject_timesheet_entries'),
